...
//     }
//     Console.WriteLine($"Sum of positive numbers in array -> {sumPositive}, sum of negative numbers in array -> {sumNegative}");
// }
...
// int[] myArray = CreateRandomArray(size, min, max);
// ShowArray(myArray);
// Console.WriteLine(FindNum(myArray, numf));
...
//         }
//     }
//     Console.WriteLine($"Number of calls:[10, 99] = {call}");
// }
